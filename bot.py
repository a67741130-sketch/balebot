...
# ================= SHARE (NEW - ONLY ADDITION) =================
def share_game_button(gid):
    return {
        "inline_keyboard": [[
            {
                "text": "📤 اشتراک‌گذاری کد",
                "url": f"https://t.me/share/url?url=🎮%20کد%20بازی:%20{gid}"
            }
        ]]
    }
...
# ================= PROCESS ROUND =================
def process_round(g):
    if g["p1_move"] is None or (g["p2"] and g["p2_move"] is None):
        return
